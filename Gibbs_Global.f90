...
!      THE MINERAL IS FOUND and its number is K
      ...
      izero=0
      call AllKduTPX(k,1,izero)     ! calculate molar volume of phase K
...
303   CONTINUE
 ...
 !     jjj=jj+j
	...
	if(iopt.ge.1000)then
		write(12,*)LandauTc(k,j),LandauSmax(k,j),LandauVmax(k,j)
		endif
