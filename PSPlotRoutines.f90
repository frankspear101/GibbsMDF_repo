...
!$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
!$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
	Subroutine DrawPSPolygon(numPts,pointArray,CMYKTemp)
	integer*4 i,numPts,iup
	real*4 pointArray(400,2),x,y,CMYKTemp(4)
	INCLUDE "PlotStuff.inc"	

!	write(psunit,5)(color(i),i=1,4)
	write(psunit,5)(CMYKTemp(i),i=1,4)
5	format(4f10.5,'    k')				! lower case "k" sets fill color
	...
	do i = 1,numPts
		x = pointArray(i,1)
		y = pointArray(i,2)
		call pplot(x,y,iup)		! note that these calls will set a stroke color, but we're not stroking
		iup = 1
		end do
	write(psunit,*)'f'		! fill [p;ugpm
!		call ppenup				! writes out an "S"
	write(psunit,*)'U'		! Turn off "group"
