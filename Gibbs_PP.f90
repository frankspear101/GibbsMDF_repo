...
!	In that case, call PRINTT(0) and this code won't be executed
	if(iPrint.eq.1)then
      		...
      		write(12,9005)(SMON(I),VN1(SMON(I)),VN2(SMON(I)),I=1,NVAR-NEQ)
!      		write(12,9005)(MON(I),VN1(MON(I)),VN2(MON(I)),I=1,NVAR-NEQ)
9005  		FORMAT('    ',16(2X,I3,1X,A2,A4))
      		write(12,9006)(SDEL(I)*NSTEP,I=1,NVAR-NEQ)
...
20	continue
	!now write record
	write(16,1010)phName(k),(compositionToWrite(i),i=1,numSysCoInFile)
